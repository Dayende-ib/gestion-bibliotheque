...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('register')): ?>
                <p class="text-sm text-gray-600"><?php echo e(__('Don\'t have an account? ')); ?></p>
                <a class="underline text-sm text-blue-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\PC\Desktop\gestion-bibliotheque\laravel-backend\resources\views/auth/login.blade.php ENDPATH**/ ?>